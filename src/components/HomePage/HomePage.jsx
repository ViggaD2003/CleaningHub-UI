    ...
    >
      ...
      <div className="py-12 ">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl mb-8 text-gray-600 font-extrabold">
      ...
      <section className="py-12 ">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="flex-1">
            <h2 className="text-3xl mb-8 text-gray-600 font-extrabold">
          ...
          <div className="flex-1 p-8">
            <img src={homepage2} alt="FAQs" className="rounded-lg shadow-lg" />
          </div>
        </div>
      </section>
    </motion.div>
